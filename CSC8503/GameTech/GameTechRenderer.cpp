...
void NCL::CSC8503::GameTechRenderer::SetGameWorld(GameWorld* world)
{
	gameWorld = world;
}

GameTechRenderer& NCL::CSC8503::GameTechRenderer::GetInstance()
{
	static GameTechRenderer renderer(nullptr);
	return renderer;
}
