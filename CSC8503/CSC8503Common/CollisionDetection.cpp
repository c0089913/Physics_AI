...
bool NCL::CollisionDetection::SphereOBBIntersection(const OBBVolume& volumeA, const Transform worldTransformA, const SphereVolume& volumeB, const Transform& worldTransformB, CollisionInfo& collisionInfo)
{
	...
	localSphereTransform.SetPosition(invTransform * worldTransformB.GetPosition());

	Transform localBoxTransform = worldTransformA;
	localBoxTransform.SetPosition(invTransform * worldTransformA.GetPosition());

	AABBVolume aabbVol(volumeA.GetHalfDimensions());

	if (AABBSphereIntersection(aabbVol, localBoxTransform, volumeB, localSphereTransform, collisionInfo))
	{
